...
player_valid_range_dict = {
    ...
    "CornersWon": [0, MAX_VALUE],
    "FoulsWon": [0, MAX_VALUE],
    "PenaltiesWon": [0, MAX_VALUE],
    "AssitsFromDummy": [0, MAX_VALUE],
    "RegularDribble": [0, 100],
    "ShieldDribble": [0, 100],
    "StrafeDribble": [0, 100],
    "AgileDribble": [0, 100],
    ...
    "CrossesAttemted": [0, MAX_VALUE],
    "SuccessfulCrosses": [0, MAX_VALUE],
    "CrossesBlocked": [0, MAX_VALUE],
    "PassesAttemptedUnderPressure": [0, MAX_VALUE],
    "PassesCompletedUnderPressure": [0, MAX_VALUE],
    "GroundPasses": [0, MAX_VALUE],
    "LobPasses": [0, MAX_VALUE],
    "ThroughPasses": [0, MAX_VALUE],
    "LoftedThroughPasses": [0, MAX_VALUE],
    "Crosses": [0, MAX_VALUE],
    "SetPiecesPasses": [0, MAX_VALUE],
    "Interceptions": [0, MAX_VALUE],
    "AerialDuels": [0, MAX_VALUE],
    "AerialDuelsWon": [0, MAX_VALUE],
